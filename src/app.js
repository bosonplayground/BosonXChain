...
const main = async() => {
    ...
    console.log('');
    console.log("sellerWalletGoerli address ", sellerWalletGoerli.address);
    console.log("buyerWalletGoerli address ", buyerWalletGoerli.address);
    console.log('');
    ...
    console.log("************* POLYGON CONTRACTS **************** ")
    console.log("BosonRouter  :", bosonRouterContractPolygon.address);
    console.log("ERC1155ERC721:", tokenContractPolygon.address);
    const localOracleAddressPolygon = await tokenContractPolygon.localOracleAddress();
    console.log("LocalOracle  :", localOracleAddressPolygon);

    console.log('');
    console.log("************* GOERLI CONTRACTS **************** ")
    console.log("BosonRouter  :", bosonRouterContractGoerli.address);
    console.log("ERC1155ERC721:", tokenContractGoerli.address);
    const localOracleAddressGoerli = await tokenContractGoerli.localOracleAddress();
    console.log("LocalOracle  :", localOracleAddressGoerli);
    console.log('');

    try {

        //Wait for user to run the demo
        const userResponseRunDemo = prompt('Run the demo? [Y/N]');

        if (userResponseRunDemo.toUpperCase() !== 'Y') {
            return;
        }
